...
The long-form account of every layer, moved out of the README so the README can say what the product is. Each section states its own boundaries; the pages under [docs/](.) go deeper still.

Contents: [Product modes](#product-modes) · [Architecture](#architecture) · [Agentic AI](#agentic-ai) · [MCP](#mcp) · [Global Eye](#global-eye) · [Decision intelligence](#decision-intelligence) · [The port digital twin](#the-port-digital-twin) · [Cargo and transshipment](#cargo-and-transshipment) · [Advisories](#advisories-the-human-boundary) · [Learning](#learning) · [RL safety](#rl-safety) · [Data honesty](#data-honesty) · [Models and accuracy](#models-and-accuracy) · [Tests and CI](#tests-and-ci) · [Limitations](#limitations)
