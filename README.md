...
Python 3.11+ and Node 24. The lock file is generated by the npm that ships
with Node 24; npm 10 and npm 11 disagree about optional peer dependencies, so
`npm ci` on an older major will refuse the lock as out of sync. CI builds on 24
for the same reason.
